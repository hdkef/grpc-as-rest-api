...
func RegisterLoginAuthServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LoginAuthServiceServer) error {
	...
	mux.Handle("POST", pattern_LoginAuthService_LoginAuth_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.LoginAuthService/LoginAuth", runtime.WithHTTPPathPattern("/v1/auth/login"))
		if err != nil {
...
func RegisterLoginAuthServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LoginAuthServiceClient) error {
	...
	mux.Handle("POST", pattern_LoginAuthService_LoginAuth_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.LoginAuthService/LoginAuth", runtime.WithHTTPPathPattern("/v1/auth/login"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_LoginAuthService_LoginAuth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "auth", "login"}, ""))
)
